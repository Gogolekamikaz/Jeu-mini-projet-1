...
public class MenuDisplay implements Graphics {
    ...
    public void draw(Canvas canvas) {
        ...
        TextGraphics text = new TextGraphics("Menu", 3.f, Color.YELLOW);
        text.setOutlineColor(Color.ORANGE);
        text.setThickness(0.05f);
        text.setBold(true);
        text.setDepth(12);
        text.setAnchor(anchor.add(new Vector(width/5, 4*height/5)));
        text.draw(canvas);
    }
}
